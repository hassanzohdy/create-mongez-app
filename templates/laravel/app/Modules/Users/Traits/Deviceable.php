...
use App\Modules\Users\Models\DeviceToken;
...
trait Deviceable
{
     ...
     */
    public function getDeviceToken(array $deviceOptions): ?DeviceToken
    {
        $deviceTokenModel = static::DEVICE_TOKEN_MODEL;
    ...
    {
        return collect($this->devices)->where('type', 'ios')->pluck('token')->toArray();
    }
}
