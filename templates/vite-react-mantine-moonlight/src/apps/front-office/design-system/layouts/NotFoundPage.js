import { Button, Container, createStyles, SimpleGrid, Text, Title, } from "@mantine/core";
    ...
    return (<Container className={classes.root}>
      ...
      <SimpleGrid spacing={80} cols={2} breakpoints={[{ maxWidth: "sm", cols: 1, spacing: 40 }]}>
        ...
        <div>
          ...
          <Button variant="outline" size="md" mt="xl" component={Link} to={URLS.home} className={classes.control}>
