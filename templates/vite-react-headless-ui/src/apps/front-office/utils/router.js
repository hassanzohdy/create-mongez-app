...
import { Guardian, ReverseGuardian, } from "apps/front-office/account/middleware";
 ...
 */
export function reverseGuardedRoutes(routes) {
    return router.group({
 ...
 */
export function accountRoutes(routes) {
    return router.group({
        middleware: [Guardian],
        routes,
    });
